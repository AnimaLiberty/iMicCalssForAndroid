...
public class FileUtil {
    ...
    public static Uri fileScanVideo(Context context, String videoPath, int videoWidth, int videoHeight,
        ...
        if (file.exists()) {
            ...
            values.put(MediaStore.Video.Media.MIME_TYPE, "icon_menu_video/mp4");
            ...
            if (uri == null) {
                MediaScannerConnection.scanFile(context, new String[]{videoPath}, new String[]{"icon_menu_video/*"}, new MediaScannerConnection.OnScanCompletedListener() {
                    @Override
